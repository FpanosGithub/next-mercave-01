...
export default function GraficasCirculacion ({circulacion}){
  ...
  return(
  <div className='p-2 overflow-y-scroll border border-slate-500 rounded-lg grid gap-1 col-span-2 grid-cols-1 2xl:grid-cols-2 3xl:col-span-1 3xl:grid-cols-1 3xl:h-[38rem]'>
    <CurvaVelocidad
